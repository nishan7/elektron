                  ...
                  <Box>
                    ...
                    <Box mb={1}>
                      ...
                      <Typography variant="body1">
                        {(() => {
                          try {
                            return new Date(health.timestamp).toLocaleString('en-US', {
                            ...
                            console.error("Error formatting health timestamp:", e);
                            return new Date(health.timestamp).toISOString(); // Fallback
                          }
                        })()}
                      </Typography>
                    </Box>
